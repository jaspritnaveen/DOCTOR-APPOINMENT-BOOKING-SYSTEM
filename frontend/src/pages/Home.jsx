          ...
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
            ...
            <div>
              <div className='lg:w-[570px]'>
                <h1 className='test-[36px] leading=[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]'>
                  We help patients live a healthy, longer life.
                </h1>
                <p className='text__para'>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Repellat quas pariatur consequuntur modi maxime consectetur
                  iure! Minima ad dolores consequuntur, ullam quidem culpa modi
                  incidunt, eius quas vel non dolorem.
                </p>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px] '>
            <div className='py-[30px] px-5'>
              ...
              <div className='mt-[30px]'>
                ...
                <p className='text-[16px] leading-7 Otext-textColor font-[400] mt-4 text-center'>
                  World-class care for everyone. Our health System offers
...
<section>
  <div className="container">
    {/* Your content for the FAQ section goes here */}
  </div>
</section>
{/* faq section end */}
